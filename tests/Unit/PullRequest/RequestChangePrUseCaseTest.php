...
use App\PullRequest\RequestChangePrUseCase;
...
class RequestChangePrUseCaseTest extends TestCase
{
    ...
    private RequestChangePrUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new RequestChangePrUseCase(
    ...
    public function testHandlePrRequestChangeFirstTime(): void
    {
        // Arrange & Assert
    ...
    public function testHandlePrChangeAlreadyRequested(): void
    {
        // Arrange & Assert
        $webHookTransfer = new WebHookTransfer(
            repository: 'example/repo',
